  ...
  render() {
    return (
      <div className="container-fluid container-lg container-xl bg-primary">
        ...
        <AuthConsumer>
          {(contxt)=>(
            <p className="dosis mini">{contxt.name}</p>
            )}
          </AuthConsumer>
          <Link to="/catalogue">
        ...
        <div className="col-1 offset-6  pl-1 offset-md-0 order-md-2">
          <Link to="/userarea">
              <i className="fas fa-child userIcon mt-2 mx-1 my-md-3 mx-md-0"></i>
          </Link>
        </div>
          <div className="col-1 offset-md-0 order-md-2 pl-0">
            <Link to="/instructions">
              <i className="fas fa-question-circle questionIcon mt-2 mx-1 my-md-3  px-md-1"></i>
            </Link>
          </div>
